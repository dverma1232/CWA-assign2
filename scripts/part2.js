...
function getInfo(){ 
	if (typeof(Storage)!=="undefined"){	// the browser supports web storage
		if (localStorage.getItem("firstName") !== null){
			...
			//Full Address
			document.getElementById("full-address").value = localStorage.getItem("streetAddress") + ", " + localStorage.getItem("suburb") + ", " + localStorage.getItem("stateText") + " " + localStorage.getItem("postcode");
